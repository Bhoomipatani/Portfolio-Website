            ...
            <div className="grid grid-cols-1 items-start lg:grid-cols-2 lg:gap-x-10 gap-y-8">
                <div className="order-2 lg:order-1 flex flex-col items-start justify-center p-2 lg:pt-10 lg:pl-10 ">
                    ...
                    <div className="flex flex-row my-10 gap-5">
                        <a href={personalData.github} className="transition-all text-gray-400 hover:scale-125 duration-300" target='_blank'>
                            <FaGithub className='size-8' />
                        </a>
                        <a href={personalData.linkedIn} className="transition-all text-gray-400 hover:scale-125 duration-300" target='_blank'>
                            <FaLinkedin className='size-8' />
                        </a>
                        <a href={personalData.email} className="transition-all text-gray-400 hover:scale-125 duration-300" target='_blank'>
                            <MdOutlineMail className='size-8' />
                        </a>
                        <a href={personalData.leetcode} className="transition-all text-gray-400 hover:scale-125 duration-300" target='_blank'>
                            <SiLeetcode className='size-8' />
                        </a>
                        <a
                            className="inline-flex items-center gap-x-2 rounded-lg bg-gray-400 px-3 py-2 text-sm font-semibold shadow-sm hover:scale-105 duration-300 "
                    ...
                    <div className="overflow-hidden border-t-[2px] border-[#1b2c68a0] px-4 lg:px-8 py-4 lg:py-8">
                        <code className="text-xs md:text-sm lg:text-base">
                            ...
                            <div>
                                ...
                                <span className="text-gray-400">{`'`}</span>
                                <span className="text-amber-300">Bhoomi Patani</span>
                                <span className="text-gray-400">{`',`}</span>
                            </div>
